    ...
    <nav>
      <div className="nav-left-container">
        <div>
          ...
          <div className="logo">
            <a href="/">
              <svg width="100" height="26" viewBox="0 0 87 22">
          ...
          <div className="mv-lng-mode">
            ...
            <svg
              style={{ transform: "rotate(90deg)", width: "7px" }}
              width="10"
              height="17"
              viewBox="0 0 10 17"
            >
        ...
        <div className="search-box">
          ...
          <input type="search" placeholder="Search Artist, Songs, Albums" />
        </div>
      </div>

      <div className="nav-right-container">
        <button className="ad-btn">
          GO Ad free <span>New</span>
        </button>
        <button className="ad-btn">Get ganna plus</button>
        <button className="lng-mode">
            ...
            <g fill="none" fillRule="evenodd">
              <g transform="translate(-1108 -117) translate(1089 58) translate(19 15) translate(0 43) translate(.5 1.5)">
                ...
                <rect
                  ...
                  rx="5.5"
                ></rect>
                <text fill="#8E8E93" fontSize="7" fontWeight="500">
                  <tspan x="3.5" y="9">
                    A
                  </tspan>
                </text>
                <text fill="#8E8E93" fontSize="5" fontWeight="500">
                  <tspan x="12" y="11.5">
                    अ
                  </tspan>
                </text>
        ...
        <button className="lng-mode">
          <svg width="22" height="22" viewBox="0 0 22 22">
            <g fill="#A7A7A9" fillRule="evenodd">
              <g className="svg_color" opacity=".75">
                <path
        ...
        <a className="nav-login" href="App.js">
          Log In/Sign Up
        </a>
      </div>
    </nav>
